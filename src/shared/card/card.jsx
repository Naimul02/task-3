...
export default function Card({product}) {
    const {name,image , price , buying_price} = product
  return (
    <div className="rounded  bg-white hover:shadow-lg border-none relative transition-all duration-500 transform hover:scale-105 overflow-hidden  shadow-gray-600 ">
